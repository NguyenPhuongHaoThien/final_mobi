...
public class ChangePassword extends BaseActivity {
    ...
    private void onClickValidateChangePassword() {
        ...
        if (StringUtil.isEmpty(strOldPassword)) {
            Toast.makeText(ChangePassword.this, getString(R.string.old_password_require), Toast.LENGTH_SHORT).show();
        } else if (StringUtil.isEmpty(strNewPassword)) {
            Toast.makeText(ChangePassword.this, getString(R.string.new_password_require), Toast.LENGTH_SHORT).show();
        } else if (StringUtil.isEmpty(strConfirmPassword)) {
            Toast.makeText(ChangePassword.this, getString(R.string.confirm_password_require), Toast.LENGTH_SHORT).show();
        } else if (!DataStoreManager.getUser().getPassword().equals(strOldPassword)) {
            Toast.makeText(ChangePassword.this, getString(R.string.old_password_invalid), Toast.LENGTH_SHORT).show();
        } else if (!strNewPassword.equals(strConfirmPassword)) {
            Toast.makeText(ChangePassword.this, getString(R.string.confirm_password_invalid), Toast.LENGTH_SHORT).show();
        } else if (strOldPassword.equals(strNewPassword)) {
            Toast.makeText(ChangePassword.this, getString(R.string.new_password_invalid), Toast.LENGTH_SHORT).show();
        } else {
        ...
        user.updatePassword(newPassword)
                .addOnCompleteListener(task -> {
                    ...
                    if (task.isSuccessful()) {
                        Toast.makeText(ChangePassword.this, getString(R.string.change_password_successfully), Toast.LENGTH_SHORT).show();
