...
import com.pro.movieFinalApp.utils.GUtils;

import java.util.List;

public class Banner extends RecyclerView.Adapter<Banner.BannerMovieViewHolder> {
    ...
    public Banner(List<Movie> mListMovies, IClickItemListener iClickItemListener) {
    ...
    public void onBindViewHolder(@NonNull BannerMovieViewHolder holder, int position) {
        ...
        GUtils.loadUrlBanner(movie.getBanner(), holder.imgBanner);
